...
class Header extends React.Component {
    ...
    render() {
        ...
        let tradeLink = this.props.lastMarket ?
            ...
            <a className={cnames({active: active.indexOf("market/") !== -1})} onClick={this._onNavigate.bind(this, "/market/USD_FLC")}><Translate component="span" content="header.exchange" /></a>;
        ...
        let settingsDropdown = <ActionSheet>
            ...
            <ActionSheet.Content>
                <ul className="no-first-element-top-border">
                    ...
                    <li>
                        <a href onClick={this._onNavigate.bind(this, "/help/introduction/flashchain")}>
