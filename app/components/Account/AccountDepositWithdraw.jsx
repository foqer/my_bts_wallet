            ...
            template: (
                <div>
                        <div className="content-block">
                            ...
                            <div className="service-selector">
                                <ul className="button-group segmented no-margin">
                                    <li onClick={this.toggleFLCervice.bind(this, "bridge")} className={btService === "bridge" ? "is-active" : ""}><a><Translate content="gateway.bridge" /></a></li>
                                </ul>
                            </div>
...
class DepositStoreWrapper extends React.Component {
    ...
    componentWillMount() {
        if (Apis.instance().chain_id.substr(0, 8) === "4018d784") { // Only fetch this when on FLC main net
