...
class BlockTradesBridgeDepositRequest extends React.Component {
        ...
        .then((json_responses) => {
            ...
            trading_pairs.forEach(pair => {
                    ...
                    output_coin_info.backingCoinType != pair.inputCoinType && (input_coin_info.restricted == false) && (output_coin_info.restricted == false))
                {
                    ...
                    {
                        if (input_coin_info.walletType != "flashchain2" &&
                            output_coin_info.walletType == "flashchain2")
                        {
                        ...
                        else if (input_coin_info.walletType == "flashchain2" &&
                                 output_coin_info.walletType != "flashchain2")
                        {
    ...
    componentWillMount() {
        ...
        .then((json_responses) => {
            ...
            this.urlConnection("https://api.flashchain.org/v2", 2);
            this.setState( {
