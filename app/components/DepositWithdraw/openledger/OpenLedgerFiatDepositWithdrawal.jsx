...
class OpenLedgerFiatDepositWithdrawCurrency extends React.Component {
    ...
    render() {
        ...
        if (this.props.deposit_allowed)
        {
            ...
            deposit_fragment = <td>Click <a href="https://flashchain.org/v/" rel="noopener noreferrer" target="_blank">here</a> to register for deposits of {this.props.deposit_asset}</td>;
        ...
        if (this.props.withdraw_allowed)
        {
            ...
            withdraw_fragment = <td>Click <a href="https://flashchain.org/v/" rel="noopener noreferrer" target="_blank">here</a> to register for withdrawals of {this.props.deposit_asset}</td>;
...
class OpenLedgerFiatDepositWithdrawal extends React.Component {
    ...
    constructor(props) {
        ...
        let json_rpc_request = { "jsonrpc": "2.0", "id": 1, "method": "isValidatedForFiat", "params": {"flashchainAccountName": this.props.account.get('name')}};
