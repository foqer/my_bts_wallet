import { FetchChain, PrivateKey, Aes, TransactionHelper, ChainTypes, ops } from "flashchainjs/es";
        ...
        for (let option of options) {
            ...
            if (option === "price_per_kbyte") {
                if (data.type === "memo" && !!data.content) {
                    ...
                    let memoFromKey = "FLC6B1taKXkDojuC1qECjvC7g186d8AdeGtz8wnqWAsoRGC6RY8Rp";

                    // Memos are optional, but if you have one you need to encrypt it
                    let memoToKey = "FLC8eLeqSZZtB1YHdw7KjQxRSRmaKAseCxhUSqaLxUdqvdGpp6nck";
