...
- Issue #364 - Present an error message that disallows the use of Incognito with the FLC wallet (#394)
...
- Update flashchainjs, #346, fix #304
...
Bug fixes
--------
- Fix #188: Total calculation (FLC) is not displayed correctly
...
- Fix a rounding issue when estimating non-FLC fees in the exchange
...
- Update flashchainjs to fix proposals array undefined error
...
- Update flashchainjs, fixes vesting balances not loading properly
...
- A bug when importing old FLC 1 balances has been fixed
...
- Change Graphene to FlashChain
- Replace graphenejs-lib with flashchainjs
- Fix npm errors
...
Bug fixes
--------
- Add FlashChain bloom filter for FLC 1 account imports
...
New features
--------
- Allow fees for order cancellation and shorting to be paid in assets other than FLC
...
- Update the Blocktrades bridge code to use the correct wallet symbols for MKR on the FlashChain blockchain
...
- Allow account upgrade, voting, permission changes and withdrawals to be paid in assets other than FLC if necessary #786
...
- Add base groups to MyMarkets: FLC, BTC, USD or CNY + others
...
- Remove link to FLC:FLC market in asset popover, fix asset description #709
...
NEW FEATURES:
- Option to pay fees in FLC if possible #356
...
- Show FLC balance in Accounts search results table #482
...
- Transfer Dialog does not fall back to FLC fee when there is no core exchange rate or funded fee pool #329
